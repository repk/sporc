...
static int isn_exec_ldsb(struct cpu *cpu, sridx rd, uint32_t v1, uint32_t v2)
{
	...
	ret = dev_read8(cpu->mem, ((addr_t)v1) + v2, &d);
	if(ret)
		goto out;
...
static int isn_exec_ldsh(struct cpu *cpu, sridx rd, uint32_t v1, uint32_t v2)
{
	...
	ret = dev_read16(cpu->mem, ((addr_t)v1) + v2, &d);
	if(ret)
		goto out;
...
static int isn_exec_ld(struct cpu *cpu, sridx rd, uint32_t v1, uint32_t v2)
{
	...
	ret = dev_read32(cpu->mem, ((addr_t)v1) + v2, &d);
	if(ret)
		goto out;
...
static int isn_exec_ldd(struct cpu *cpu, sridx rd, uint32_t v1, uint32_t v2)
{
	...
	ret = dev_read32(cpu->mem, ((addr_t)v1) + v2 + 4, &d);
	if(ret)
		goto out;
...
{
	return dev_write8(cpu->mem, ((addr_t)v1) + v2,
			scpu_get_reg(cpu, rd));
}
...
{
	return dev_write16(cpu->mem, ((addr_t)v1) + v2,
...
{
	return dev_write32(cpu->mem, ((addr_t)v1) + v2,
...
static int isn_exec_std(struct cpu *cpu, sridx rd, uint32_t v1, uint32_t v2)
{
	...
	ret = dev_write32(cpu->mem, ((addr_t)v1) + v2,
			htobe32(scpu_get_reg(cpu, rd)));
	if(ret != 0)
		goto out;

	ret = dev_write32(cpu->mem, ((addr_t)v1) + v2 + 4,
