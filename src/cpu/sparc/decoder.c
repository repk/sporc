...
static int isn_decode_op3_2(struct sparc_isn *isn)
{
	...
	static struct _op3_isn_type const _isn_op3_2[] = {
		...
		_OP3_ISN_INT(37, SI_SLL),
		_OP3_ISN_INT(38, SI_SRL),
		_OP3_ISN_INT(39, SI_SRA),
		_OP3_ISN_INT(0, SI_ADD),
		_OP3_ISN_INT(16, SI_ADDCC),
		_OP3_ISN_INT(8, SI_ADDX),
		_OP3_ISN_INT(24, SI_ADDXCC),
		_OP3_ISN_INT(32, SI_TADDCC),
		_OP3_ISN_INT(34, SI_TADDCCTV),
		_OP3_ISN_INT(33, SI_TSUBCC),
		_OP3_ISN_INT(35, SI_TSUBCCTV),
		_OP3_ISN_INT(4, SI_SUB),
		_OP3_ISN_INT(20, SI_SUBCC),
		_OP3_ISN_INT(12, SI_SUBX),
		_OP3_ISN_INT(28, SI_SUBXCC),
		_OP3_ISN_INT(36, SI_MULSCC),
		_OP3_ISN_INT(10, SI_UMUL),
...
static int isn_decode_op3_3(struct sparc_isn *isn)
{
	...
	static struct _op3_isn_type const _isn_op3_3[] = {
		...
		_OP3_ISN_INT(26, SI_LDSHA),
		_OP3_ISN_INT(1, SI_LDUB),
		_OP3_ISN_INT(17, SI_LDUBA),
		_OP3_ISN_INT(2, SI_LDUH),
		_OP3_ISN_INT(18, SI_LDUHA),
		_OP3_ISN_INT(0, SI_LD),
		_OP3_ISN_INT(16, SI_LDA),
		_OP3_ISN_INT(3, SI_LDD),
		_OP3_ISN_INT(19, SI_LDDA),
		_OP3_ISN_INT(5, SI_STB),
		_OP3_ISN_INT(21, SI_STBA),
		_OP3_ISN_INT(6, SI_STH),
		_OP3_ISN_INT(22, SI_STHA),
		_OP3_ISN_INT(4, SI_ST),
		_OP3_ISN_INT(20, SI_STA),
		_OP3_ISN_INT(7, SI_STD),
		_OP3_ISN_INT(23, SI_STDA),
		_OP3_ISN_INT(13, SI_LDSTUB),
		_OP3_ISN_INT(29, SI_LDSTUBA),
		_OP3_ISN_INT(15, SI_SWAP),
		_OP3_ISN_INT(31, SI_SWAPA),
	};
